...
pub const Addr = struct {
  ...
  pub fn get_vendor_id(self: @This()) u16 { return self.read(u16, 0x00); }
  pub fn get_product_id(self: @This()) u16 { return self.read(u16, 0x02); }
  pub fn get_class(self: @This()) u8 { return self.read(u8, 0x0B); }
  pub fn get_subclass(self: @This()) u8 { return self.read(u8, 0x0A); }
  pub fn get_progif(self: @This()) u8 { return self.read(u8, 0x09); }
  pub fn get_header_type(self: @This()) u8 { return self.read(u8, 0x0E); }
};
